...
namespace StoresG8.API.Migrations
{
    ...
    [Migration("20230504195203_Users")]
    partial class Users
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("StoresG8.Shared.Entities.ProductCategory", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("StoresG8.Shared.Entities.ProductImage", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("StoresG8.Shared.Entities.User", b =>
                {
                    b.Property<string>("Id")
                        .HasColumnType("nvarchar(450)");
            ...
            modelBuilder.Entity("Microsoft.AspNetCore.Identity.IdentityUserClaim<string>", b =>
                {
                    b.HasOne("StoresG8.Shared.Entities.User", null)
                        .WithMany()
            ...
            modelBuilder.Entity("StoresG8.Shared.Entities.User", b =>
                {
                    b.HasOne("StoresG8.Shared.Entities.City", "City")
                        .WithMany("Users")
